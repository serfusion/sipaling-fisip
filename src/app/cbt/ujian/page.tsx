...
export const metadata: Metadata = {
  ...
  description: "Masuk dengan nama, nomor peserta, dan kode ujian. Tanpa membuat akun.",
};
...
// lalu berarti peserta menatap layar yang salah pada saat yang paling genting.
