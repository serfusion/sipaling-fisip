...
const PETA_JUDUL: PolaBagian[] = [
  ...
  { pola: /^(?:hasil|temuan)$/i, bagian: "results", catatan: "Judul singkat. Hanya temuan, tanpa penafsiran. Kala lampau." },
  { pola: /^(?:metode|metodologi)$/i, bagian: "methods", catatan: "Judul singkat. Ditulis dalam kala lampau." },
  { pola: /^(?:pendahuluan)$/i, bagian: "introduction", catatan: "Judul singkat. Diurai menjadi tiga gerakan CARS." },
  { pola: /^(?:tinjauan\s+pustaka|kajian\s+pustaka|landasan\s+teori)$/i, bagian: "literature", catatan: "Judul singkat. Uraian teori dipangkas paling banyak." },
